...
var DateInput = function (_a) {
    ...
    var _e = useInput(__assign({ defaultValue: defaultValue,
        format: format, formatOnBlur: true, initialValue: initialValue,
        name: name,
        onBlur: onBlur,
        onChange: onChange,
        onFocus: onFocus,
        ...
        resource: resource,
        source: source,
        validate: validate }, rest)), id = _e.id, input = _e.input, isRequired = _e.isRequired, meta = _e.meta;
