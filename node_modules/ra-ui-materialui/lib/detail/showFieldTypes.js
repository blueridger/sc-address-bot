...
var Datagrid_1 = __importDefault(require("../list/datagrid/Datagrid"));
...
var showFieldTypes = {
    show: {
        component: function (props) { return (React.createElement(SimpleShowLayout_1.default, __assign({}, props))); },
    ...
    array: {
        ...
        component: function (_a) {
            ...
            return (React.createElement(ArrayField_1.default, __assign({}, props),
                React.createElement(Datagrid_1.default, null, children)));
        },
    ...
    date: {
        ...
        representation: function (props) {
            return "<DateField source=\"" + props.source + "\" />";
        },
    },
    email: {
        component: EmailField_1.default,
        representation: function (props) {
            return "<EmailField source=\"" + props.source + "\" />";
        },
    },
    id: {
        component: TextField_1.default,
        representation: function (props) {
            return "<TextField source=\"" + props.source + "\" />";
        },
    },
    number: {
        component: NumberField_1.default,
        representation: function (props) {
            return "<NumberField source=\"" + props.source + "\" />";
        },
    },
    reference: {
    ...
    richText: {
        ...
        representation: function (props) {
            return "<RichTextField source=\"" + props.source + "\" />";
        },
    },
    string: {
        component: TextField_1.default,
    ...
    url: {
        ...
        representation: function (props) {
            return "<UrlField source=\"" + props.source + "\" />";
        },
    },
};
