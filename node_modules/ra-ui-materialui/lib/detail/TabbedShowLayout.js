 ...
 *     export default App;
 */
exports.TabbedShowLayout = function (props) {
    ...
    return (React.createElement("div", __assign({ className: className, key: version }, sanitizeRestProps(rest)),
        ...
        React.createElement("div", { className: classes.content }, react_1.Children.map(nonNullChildren, function (tab, index) {
            return tab && react_1.isValidElement(tab) ? (syncWithLocation ? (React.createElement(react_router_dom_1.Route, { exact: true, path: ra_core_1.escapePath(TabbedShowLayoutTabs_1.getTabFullPath(tab, index, match.url)), render: function () {
                ...
                } })) : tabValue === index ? (react_1.cloneElement(tab, {
                context: 'content',
                resource: resource,
                record: record,
                basePath: basePath,
