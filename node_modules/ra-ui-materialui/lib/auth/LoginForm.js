...
var Input = function (_a) {
    ...
    return (React.createElement(core_1.TextField, __assign({ error: !!(touched && error), helperText: touched && error }, inputProps, props, { fullWidth: true })));
};
var LoginForm = function (props) {
    var redirectTo = props.redirectTo;
    var _a = ra_core_1.useSafeSetState(false), loading = _a[0], setLoading = _a[1];
    ...
    return (React.createElement(react_final_form_1.Form, { onSubmit: submit, validate: validate, render: function (_a) {
            ...
            return (React.createElement("form", { onSubmit: handleSubmit, noValidate: true },
                ...
                React.createElement(core_1.CardActions, null,
                    React.createElement(core_1.Button, { variant: "contained", type: "submit", color: "primary", disabled: loading, className: classes.button },
                        loading && (React.createElement(core_1.CircularProgress, { className: classes.icon, size: 18, thickness: 2 })),
