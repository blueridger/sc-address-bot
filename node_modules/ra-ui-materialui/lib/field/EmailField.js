...
var EmailField = react_1.memo(function (props) {
    ...
    return (React.createElement(core_1.Link, __assign({ className: className, href: "mailto:" + value, onClick: stopPropagation, variant: "body2" }, sanitizeFieldRestProps_1.default(rest)), value));
});
