 ...
 */
exports.ArrayField = react_1.memo(function (props) {
    ...
    var _a = react_1.useState(initialState.ids), ids = _a[0], setIds = _a[1];
    var _b = react_1.useState(initialState.data), data = _b[0], setData = _b[1];
