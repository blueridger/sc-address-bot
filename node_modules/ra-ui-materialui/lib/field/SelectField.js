 ...
 */
exports.SelectField = react_1.memo(function (props) {
    ...
    if (!choice) {
        return emptyText ? (React.createElement(core_1.Typography, __assign({ component: "span", variant: "body2", className: className }, sanitizeFieldRestProps_1.default(rest)), emptyText)) : null;
    }
    var choiceText = getChoiceText(choice);
    return (React.createElement(core_1.Typography, __assign({ component: "span", variant: "body2", className: className }, sanitizeFieldRestProps_1.default(rest)), choiceText));
});
...
exports.SelectField.propTypes = __assign(__assign(__assign({}, core_1.Typography.propTypes), types_1.fieldPropTypes), { choices: prop_types_1.default.arrayOf(prop_types_1.default.object).isRequired, optionText: prop_types_1.default.oneOfType([
