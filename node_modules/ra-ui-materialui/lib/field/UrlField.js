...
var UrlField = react_1.memo(function (props) {
    ...
    return (React.createElement(core_1.Link, __assign({ className: className, href: value, variant: "body2" }, sanitizeFieldRestProps_1.default(rest)), value));
});
