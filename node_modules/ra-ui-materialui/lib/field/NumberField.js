 ...
 * <span>25,99 $US</span>
 */
exports.NumberField = react_1.memo(function (props) {
    ...
    return (React.createElement(Typography_1.default, __assign({ variant: "body2", component: "span", className: className }, sanitizeFieldRestProps_1.default(rest)), hasNumberFormat ? value.toLocaleString(locales, options) : value));
});
