...
var ReferenceField = function (props) {
    ...
    var isReferenceDeclared = react_redux_1.useSelector(function (state) { return typeof state.admin.resources[props.reference] !== 'undefined'; });
    ...
    return get_1.default(record, source) == null ? (emptyText ? (React.createElement(core_1.Typography, { component: "span", variant: "body2" }, emptyText)) : null) : (React.createElement(exports.NonEmptyReferenceField, __assign({}, rest, { record: record, source: source })));
};
...
exports.ReferenceFieldView = function (props) {
    ...
    if (resourceLinkPath) {
        return (React.createElement(ra_core_1.RecordContextProvider, { value: referenceRecord },
            React.createElement(Link_1.default, { to: resourceLinkPath, className: className, onClick: stopPropagation }, react_1.cloneElement(react_1.Children.only(children), __assign({ className: classnames_1.default(children.props.className, classes.link // force color override for Typography components
    ...
    return (React.createElement(ra_core_1.RecordContextProvider, { value: referenceRecord }, react_1.cloneElement(react_1.Children.only(children), __assign({ record: referenceRecord, resource: reference, basePath: basePath,
        translateChoice: translateChoice }, sanitizeFieldRestProps_1.default(rest)))));
};
