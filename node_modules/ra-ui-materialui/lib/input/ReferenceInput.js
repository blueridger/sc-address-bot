...
var ReferenceInput = function (props) {
    ...
    return (react_1.default.createElement(exports.ReferenceInputView, __assign({}, inputProps, rest, ra_core_1.useReferenceInputController(__assign(__assign({}, rest), inputProps)))));
};
...
exports.ReferenceInputView = function (props) {
