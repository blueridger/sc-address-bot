...
exports.getArrayInputError = void 0;
...
var ArrayInput = function (_a) {
    ...
    var arrayInputError = exports.getArrayInputError(error || submitError);
    return (React.createElement(core_1.FormControl, __assign({ fullWidth: true, margin: "normal", className: className, error: (touched || dirty) && !!arrayInputError }, sanitizeInputRestProps_1.default(rest)),
...
exports.getArrayInputError = function (error) {
