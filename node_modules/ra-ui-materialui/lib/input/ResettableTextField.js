...
exports.resettableStyles = void 0;
...
var ResettableTextField = function (props) {
    ...
    var getEndAdornment = function () {
        ...
        if (!resettable) {
            ...
            if (clearAlwaysVisible) {
                ...
                return (React.createElement(core_1.InputAdornment, { position: "end", classes: {
                        root: props.select ? selectAdornment : null,
                    } },
                    React.createElement(core_1.IconButton, { className: clearButton, "aria-label": translate('ra.action.clear_input_value'), title: translate('ra.action.clear_input_value'), disableRipple: true, disabled: true },
            ...
            return (React.createElement(core_1.InputAdornment, { position: "end", classes: {
                ...
                React.createElement(core_1.IconButton, { className: clearButton, "aria-label": translate('ra.action.clear_input_value'), title: translate('ra.action.clear_input_value'), disableRipple: true, onClick: handleClickClearButton, onMouseDown: handleMouseDownClearButton, disabled: disabled },
    ...
    return (React.createElement(core_1.TextField, __assign({ classes: restClasses, value: value, InputProps: __assign({ classes: props.select && variant === 'filled'
...
var useStyles = styles_1.makeStyles(exports.resettableStyles, {
