...
var ReferenceArrayInput = function (_a) {
    ...
    var listContext = react_1.useMemo(function () { return (__assign(__assign({}, controllerProps), { 
    ...
    return (React.createElement(ra_core_1.ResourceContextProvider, { value: props.reference },
        React.createElement(ra_core_1.ReferenceArrayInputContextProvider, { value: controllerProps },
...
exports.ReferenceArrayInputView = function (_a) {
    ...
    return React.cloneElement(children, __assign(__assign({ allowEmpty: allowEmpty, basePath: basePath
        ...
        error: error,
        input: input,
        isRequired: isRequired, label: translatedLabel, loaded: loaded,
        loading: loading, meta: __assign(__assign({}, meta), { helperText: warning || false }), onChange: onChange,
        options: options, resource: reference, setFilter: setFilter,
