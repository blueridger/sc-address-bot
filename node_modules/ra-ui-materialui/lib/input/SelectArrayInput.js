...
var SelectArrayInput = function (props) {
    ...
    var handleChange = react_1.useCallback(function (event, newItem) {
        if (newItem) {
            input.onChange(__spreadArrays(input.value, [getChoiceValue(newItem)]));
            return;
        }
        input.onChange(event);
    }, [input, getChoiceValue]);
    var _h = useSupportCreateSuggestion_1.useSupportCreateSuggestion({
        create: create,
    ...
    var finalChoices = create || onCreate ? __spreadArrays(choices, [createItem]) : choices;
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(core_1.FormControl, __assign({ margin: margin, className: classnames_1.default(classes.root, className), error: touched && !!(error || submitError), variant: variant }, sanitizeRestProps(rest)),
