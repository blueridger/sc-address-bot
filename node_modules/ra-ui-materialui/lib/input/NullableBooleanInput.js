...
var NullableBooleanInput = function (props) {
    ...
    var _h = ra_core_1.useInput(__assign({ format: format,
        onBlur: onBlur,
        onChange: onChange,
        onFocus: onFocus,
        parse: parse,
