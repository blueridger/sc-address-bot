...
var TextInput = function (props) {
    ...
    var _a = ra_core_1.useInput(__assign({ format: format,
        ...
        parse: parse,
        resource: resource,
        source: source, type: 'text', validate: validate }, rest)), id = _a.id, input = _a.input, isRequired = _a.isRequired, _b = _a.meta, error = _b.error, submitError = _b.submitError, touched = _b.touched;
