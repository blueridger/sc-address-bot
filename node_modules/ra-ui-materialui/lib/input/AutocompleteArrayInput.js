...
var AutocompleteArrayInput = function (props) {
    ...
    var debouncedSetFilter = react_1.useCallback(debounce_1.default(setFilter || DefaultSetFilter, debounceDelay), [setFilter, debounceDelay]);
    ...
    var handleChange = react_1.useCallback(function (item, newItem) {
    ...
    var _p = useSupportCreateSuggestion_1.useSupportCreateSuggestion({
        create: create,
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(downshift_1.default, __assign({ inputValue: filterValue, onChange: handleChangeWithCreateSupport, selectedItem: selectedItems, itemToString: function (item) { return getChoiceValue(item); } }, rest), function (_a) {
            ...
            return (react_1.default.createElement("div", { className: classes.container },
                react_1.default.createElement(core_1.TextField, __assign({ id: id, fullWidth: fullWidth, InputProps: __assign({ inputRef: ra_core_1.mergeRefs([
                            storeInputRef,
                            inputRef,
                        ]), classes: {
