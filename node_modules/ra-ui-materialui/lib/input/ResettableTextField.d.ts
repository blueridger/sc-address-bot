...
export declare const resettableStyles: Styles<Theme, ResettableTextFieldProps>;
declare const useStyles: (props: ResettableTextFieldProps) => Record<string, string>;
interface Props {
