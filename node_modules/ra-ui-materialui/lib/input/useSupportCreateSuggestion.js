 ...
 */
exports.useSupportCreateSuggestion = function (options) {
    ...
    var _e = react_1.useState(false), renderOnCreate = _e[0], setRenderOnCreate = _e[1];
    var context = {
        filter: filter,
    ...
    return {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!!react_1.isValidElement(create)) return [3 /*break*/, 2];
        ...
        createElement: renderOnCreate && react_1.isValidElement(create) ? (React.createElement(CreateSuggestionContext.Provider, { value: context }, create)) : null,
    };
};
var CreateSuggestionContext = react_1.createContext(undefined);
exports.useCreateSuggestionContext = function () {
    return react_1.useContext(CreateSuggestionContext);
};
