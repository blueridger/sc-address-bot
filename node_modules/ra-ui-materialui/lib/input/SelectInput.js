...
exports.SelectInput = function (props) {
    ...
    var handleChange = react_1.useCallback(function (event, newItem) { return __awaiter(void 0, void 0, void 0, function () {
        var value;
    ...
    var _e = useSupportCreateSuggestion_1.useSupportCreateSuggestion({
        create: create,
...
var useStyles = styles_1.makeStyles(function (theme) { return (__assign(__assign({}, ResettableTextField_1.resettableStyles), { input: {
