...
var CheckboxGroupInput = function (props) {
    ...
    return (React.createElement(FormControl_1.default, __assign({ component: "fieldset", margin: margin, error: touched && !!(error || submitError), className: classnames_1.default(classes.root, className) }, sanitizeRestProps(rest)),
