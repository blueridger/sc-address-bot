...
var SimpleListLoading = function (props) {
    ...
    return oneSecondHasPassed ? (React.createElement(List_1.default, __assign({ className: className }, rest), times(nbFakeLines, function (key) { return (React.createElement(ListItem_1.default, { key: key },
