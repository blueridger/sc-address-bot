...
var SimpleList = function (props) {
    ...
    var renderAvatar = function (id, avatarCallback) {
        ...
        if (typeof avatarValue === 'string' &&
            ...
            return React.createElement(core_1.Avatar, { src: avatarValue });
        }
        else {
            return React.createElement(core_1.Avatar, null, avatarValue);
        }
    };
    return (total > 0 && (React.createElement(core_1.List, __assign({ className: className }, ra_core_1.sanitizeListRestProps(rest)), ids.map(function (id, rowIndex) { return (React.createElement(ra_core_1.RecordContextProvider, { key: id, value: data[id] },
        React.createElement("li", null,
            React.createElement(LinkOrNot, { linkType: linkType, basePath: basePath, id: id, record: data[id] },
                React.createElement(core_1.ListItem, { button: !!linkType, style: rowStyle
                    ...
                    leftAvatar && (React.createElement(core_1.ListItemAvatar, null, renderAvatar(id, leftAvatar))),
                    React.createElement(core_1.ListItemText, { primary: React.createElement("div", null,
                            react_1.isValidElement(primaryText)
                                ? primaryText
                                : primaryText(data[id], id),
                            !!tertiaryText &&
                                (react_1.isValidElement(tertiaryText) ? (tertiaryText) : (React.createElement("span", { className: classes.tertiary }, tertiaryText(data[id], id))))), secondary: !!secondaryText &&
                            (react_1.isValidElement(secondaryText)
                                ? secondaryText
                                : secondaryText(data[id], id)) }),
                    (rightAvatar || rightIcon) && (React.createElement(core_1.ListItemSecondaryAction, null,
                        rightAvatar && (React.createElement(core_1.Avatar, null, renderAvatar(id, rightAvatar))),
...
var LinkOrNot = function (props) {
    var classesOverride = props.classes, linkType = props.linkType, basePath = props.basePath, id = props.id, children = props.children, record = props.record;
