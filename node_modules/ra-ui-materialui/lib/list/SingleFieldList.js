...
var SingleFieldList = function (props) {
    ...
    var _c = ra_core_1.useListContext(props), ids = _c.ids, data = _c.data, loaded = _c.loaded, basePath = _c.basePath;
    ...
    return (React.createElement(Component, __assign({ className: classnames_1.default(classes.root, className) }, ra_core_1.sanitizeListRestProps(rest)), ids.map(function (id) {
        var resourceLinkPath = !linkType
            ? false
            : ra_core_1.linkToRecord(basePath, id, linkType);
        if (resourceLinkPath) {
            return (React.createElement(ra_core_1.RecordContextProvider, { value: data[id], key: id },
                React.createElement(Link_1.default, { className: classes.link, key: id, to: resourceLinkPath, onClick: stopPropagation }, react_1.cloneElement(react_1.Children.only(children), {
                    record: data[id],
                    resource: resource,
                    basePath: basePath,
        ...
        return (React.createElement(ra_core_1.RecordContextProvider, { value: data[id], key: id }, react_1.cloneElement(react_1.Children.only(children), {
            key: id,
            record: data[id],
            resource: resource,
            basePath: basePath,
