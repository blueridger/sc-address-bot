...
var ListToolbar = function (props) {
    ...
    return Array.isArray(filters) ? (React.createElement(FilterContext_1.FilterContext.Provider, { value: filters },
        React.createElement(core_1.Toolbar, { className: classes.toolbar },
            ...
            actions &&
                React.cloneElement(actions, __assign(__assign(__assign({}, rest), { className: classes.actions }), actions.props))))) : (React.createElement(core_1.Toolbar, { className: classes.toolbar },
        filters &&
