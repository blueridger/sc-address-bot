...
exports.DatagridHeaderCell = function (props) {
    ...
    return (React.createElement(core_1.TableCell, __assign({ className: classnames_1.default(className, field.props.headerClassName), align: field.props.textAlign, variant: "head" }, rest), updateSort &&
