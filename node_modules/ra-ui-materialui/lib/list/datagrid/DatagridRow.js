...
var DatagridRow = react_1.default.forwardRef(function (props, ref) {
    ...
    var context = useDatagridContext_1.useDatagridContext();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    switch (effect) {
                        case 'edit':
                            history.push(ra_core_1.linkToRecord(basePath || "/" + resource, id));
                            return [2 /*return*/];
                        case 'show':
                            history.push(ra_core_1.linkToRecord(basePath || "/" + resource, id, 'show'));
                            return [2 /*return*/];
                        case 'expand':
    ...
    return (react_1.default.createElement(ra_core_1.RecordContextProvider, { value: record },
        react_1.default.createElement(core_1.TableRow, __assign({ ref: ref, className: className, key: id, style: style, hover: hover, onClick: handleClick }, rest),
            expand && (react_1.default.createElement(core_1.TableCell, { padding: "none", className: classes.expandIconCell }, expandable && (react_1.default.createElement(ExpandRowButton_1.default, { classes: classes, expanded: expanded, onClick: handleToggleExpand, expandContentId: id + "-expand" })))),
            hasBulkActions && (react_1.default.createElement(core_1.TableCell, { padding: "checkbox" }, selectable && (react_1.default.createElement(core_1.Checkbox, { "aria-label": translate('ra.action.select_row', {
                    _: 'Select this row',
        ...
        expandable && expanded && (react_1.default.createElement(core_1.TableRow, { key: id + "-expand", id: id + "-expand" },
