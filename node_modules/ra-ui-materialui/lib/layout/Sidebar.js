...
var Sidebar = function (props) {
    ...
    return isXSmall ? (React.createElement(core_1.Drawer, __assign({ variant: "temporary", open: open, PaperProps: {
        ...
        }, onClose: toggleSidebar, classes: classes }, rest), children)) : isSmall ? (React.createElement(core_1.Drawer, __assign({ variant: "permanent", open: open, PaperProps: {
            className: drawerPaper,
        }, onClose: toggleSidebar, classes: classes }, rest),
        React.createElement("div", { className: fixed }, children))) : (React.createElement(core_1.Drawer, __assign({ variant: "permanent", open: open, PaperProps: {
            className: drawerPaper,
        }, onClose: toggleSidebar, classes: classes }, rest),
