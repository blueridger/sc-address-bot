...
var createMuiTheme_1 = require("./createMuiTheme");
...
var Layout = function (_a) {
    ...
    var _b = react_1.useState(function () { return createMuiTheme_1.createMuiTheme(themeOverride); }), theme = _b[0], setTheme = _b[1];
    react_1.useEffect(function () {
        if (themeProp.current !== themeOverride) {
            themeProp.current = themeOverride;
            setTheme(createMuiTheme_1.createMuiTheme(themeOverride));
        }
