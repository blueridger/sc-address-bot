...
var SortButton = function (props) {
    ...
    var buttonLabel = translate(label, {
        field: translate.apply(void 0, ra_core_1.getFieldLabelTranslationArgs({
            resource: resource,
    ...
    return (React.createElement(React.Fragment, null,
        isXSmall ? (React.createElement(core_1.Tooltip, { title: buttonLabel },
            React.createElement(core_1.IconButton, { "aria-label": buttonLabel, color: "primary", onClick: handleClick }, icon))) : (React.createElement(core_1.Button, { "aria-controls": "simple-menu", "aria-haspopup": "true", color: "primary", onClick: handleClick, startIcon: icon, endIcon: React.createElement(ArrowDropDown_1.default, null), size: "small" }, buttonLabel)),
        React.createElement(core_1.Menu, { id: "simple-menu", anchorEl: anchorEl, keepMounted: true, open: Boolean(anchorEl), onClose: handleClose }, fields.map(function (field) { return (React.createElement(core_1.MenuItem, { onClick: handleChangeSort, "data-sort": field, key: field },
            translate.apply(void 0, ra_core_1.getFieldLabelTranslationArgs({
                resource: resource,
                source: field,
            })),
            ' ',
