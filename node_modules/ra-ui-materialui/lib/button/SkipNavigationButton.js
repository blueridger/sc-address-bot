...
var SkipNavigationButton = function () {
    ...
    return (react_1.default.createElement(Button_1.default, { onClick: skipToContent, className: classnames_1.default(classes.skipToContentButton, 'skip-nav-button'), label: translate('ra.navigation.skip_nav'), variant: "contained" }));
};
