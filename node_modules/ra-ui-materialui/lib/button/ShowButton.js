...
var ShowButton = function (props) {
    ...
    return (React.createElement(Button_1.default, __assign({ component: react_router_dom_1.Link, to: react_1.useMemo(function () { return ({
            pathname: record
                ? ra_core_1.linkToRecord(basePath || "/" + resource, record.id) + "/show"
                : '',
