...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/plugins/github/bin/fetchAndPrintGithubRepo.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./src/backend/memoryCacheProvider.js":
/*!********************************************!*\
  !*** ./src/backend/memoryCacheProvider.js ***!
  \********************************************/
/*! exports provided: MemoryCacheProvider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"MemoryCacheProvider\", function() { return MemoryCacheProvider; });\n/* harmony import */ var better_sqlite3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! better-sqlite3 */ \"better-sqlite3\");\n/* harmony import */ var better_sqlite3__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(better_sqlite3__WEBPACK_IMPORTED_MODULE_0__);\nfunction _defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true});}else{obj[key]=value;}return obj;}/**\n * An in-memory CacheProvider.\n *\n * Using the same ID's will produce the same cache, however data will be lost when\n * the process exits, or references to the MemoryCacheProvider are deleted.\n *\n * Useful for tests or less I/O intense commands which should run in isolation.\n */class MemoryCacheProvider{constructor(){_defineProperty(this,\"_instances\",new Map());}/**\n   * Returns a Database handle associated with this `id`,\n   * an existing Database from the cache *may* be provided.\n   *\n   * Note: the exact Database object may be shared within the process.\n   */async database(id){let db=this._instances.get(id);if(!db){db=new better_sqlite3__WEBPACK_IMPORTED_MODULE_0___default.a(\":memory:\");this._instances.set(id,db);}return db;}}\n\n//# sourceURL=webpack:///./src/backend/memoryCacheProvider.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var json_stable_stringify__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! json-stable-stringify */ \"json-stable-stringify\");\n/* harmony import */ var json_stable_stringify__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(json_stable_stringify__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _fetchGithubRepo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../fetchGithubRepo */ \"./src/plugins/github/fetchGithubRepo.js\");\n/* harmony import */ var _repoId__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../repoId */ \"./src/plugins/github/repoId.js\");\n/* harmony import */ var _backend_memoryCacheProvider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../backend/memoryCacheProvider */ \"./src/backend/memoryCacheProvider.js\");\n/* harmony import */ var _token__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../token */ \"./src/plugins/github/token.js\");\n/*\n * Command-line utility to fetch GitHub data using the API in\n * ../fetchGithubRepo, and print it to stdout. Useful for testing or\n * saving some data to disk.\n *\n * Usage:\n *\n *   node bin/fetchAndPrintGithubRepo.js REPO_OWNER REPO_NAME [TOKEN]\n *\n * where TOKEN is an optional GitHub authentication token, as generated\n * from https://github.com/settings/tokens/new.\n */function parseArgs(){const argv=process.argv.slice(2);const fail=()=>{const invocation=process.argv.slice(0,2).join(\" \");throw new Error(\"Usage: \".concat(invocation,\" REPO_OWNER REPO_NAME GITHUB_TOKEN\"));};if(argv.length<2){fail();}const[owner,name,unvalidatedGithubToken,...rest]=argv;const githubToken=Object(_token__WEBPACK_IMPORTED_MODULE_4__[\"validateToken\"])(unvalidatedGithubToken);const result={owner,name,githubToken};if(rest.length>0){fail();}return result;}function main(){const args=parseArgs();const repoId=Object(_repoId__WEBPACK_IMPORTED_MODULE_2__[\"makeRepoId\"])(args.owner,args.name);const cache=new _backend_memoryCacheProvider__WEBPACK_IMPORTED_MODULE_3__[\"MemoryCacheProvider\"]();const options={token:args.githubToken,cache};Object(_fetchGithubRepo__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(repoId,options).then(data=>{console.log(json_stable_stringify__WEBPACK_IMPORTED_MODULE_0___default()(data,{space:4}));}).catch(errors=>{console.error(\"Errors processing the result:\");console.error(errors);process.exit(1);});}main();\n\n//# sourceURL=webpack:///./src/plugins/github/bin/fetchAndPrintGithubRepo.js?");
