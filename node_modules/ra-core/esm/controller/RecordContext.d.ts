...
export declare const RecordContextProvider: <RecordType extends Record | Pick<Record, import("../types").Identifier> = Record>({ children, value, }: RecordContextOptions<RecordType>) => JSX.Element;
 ...
 */
export declare const useRecordContext: <RecordType extends Record | Pick<Record, import("../types").Identifier> = Record>(props?: UseRecordContextParams<RecordType>) => RecordType;
