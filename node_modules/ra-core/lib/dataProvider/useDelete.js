...
var useDelete = function (resource, id, previousData, options) {
    ...
    var _a = useMutation_1.default({ type: 'delete', resource: resource, payload: { id: id, previousData: previousData } }, options), mutate = _a[0], state = _a[1];
    var deleteOne = react_1.useCallback(function (resource, id, previousData, options) {
