...
var useCreate = function (resource, data, options) {
    var _a = useMutation_1.default({ type: 'create', resource: resource, payload: { data: data } }, options), mutate = _a[0], state = _a[1];
    var create = react_1.useCallback(function (resource, data, options) {
