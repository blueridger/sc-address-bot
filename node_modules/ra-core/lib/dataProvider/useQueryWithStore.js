 ...
 * };
 */
exports.useQueryWithStore = function (query, options, dataSelector, totalSelector, isDataLoaded) {
    ...
    var _a = react_1.useState(0), innerVersion = _a[0], setInnerVersion = _a[1];
    ...
    var _b = hooks_1.useSafeSetState({
        data: data,
        total: total,
        error: null,
