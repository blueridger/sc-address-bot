...
var useUpdateMany = function (resource, ids, data, options) {
    var _a = useMutation_1.default({ type: 'updateMany', resource: resource, payload: { ids: ids, data: data } }, options), mutate = _a[0], state = _a[1];
    var updateMany = react_1.useCallback(function (resource, ids, data, options) {
