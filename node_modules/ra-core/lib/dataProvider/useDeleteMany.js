...
var useDeleteMany = function (resource, ids, options) {
    var _a = useMutation_1.default({ type: 'deleteMany', resource: resource, payload: { ids: ids } }, options), mutate = _a[0], state = _a[1];
    var deleteMany = react_1.useCallback(function (resource, ids, options) {
