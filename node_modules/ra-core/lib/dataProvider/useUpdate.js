...
var useUpdate = function (resource, id, data, previousData, options) {
    var _a = useMutation_1.default({ type: 'update', resource: resource, payload: { id: id, data: data, previousData: previousData } }, options), mutate = _a[0], state = _a[1];
    var update = react_1.useCallback(function (resource, id, data, previousData, options) {
