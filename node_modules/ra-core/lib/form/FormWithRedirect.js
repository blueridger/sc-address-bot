...
var FormWithRedirect = function (_a) {
    ...
    var finalMutators = react_1.useMemo(function () {
    ...
    var finalInitialValues = react_1.useMemo(function () { return getFormInitialValues_1.default(initialValues, defaultValue, record); }, [JSON.stringify({ initialValues: initialValues, defaultValue: defaultValue, record: record })]); // eslint-disable-line
...
var FormView = function (_a) {
    ...
    useResetSubmitErrors_1.default();
