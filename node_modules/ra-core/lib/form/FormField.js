...
var FormField = function (props) {
    ...
    React.createElement(rest.component, __assign({ input: input, id: finalId }, rest))) : (React.createElement(react_final_form_1.Field, __assign({}, rest, { id: finalId, name: rest.source, isRequired: exports.isRequired(validate), validate: sanitizedValidate })));
};
FormField.propTypes = {
