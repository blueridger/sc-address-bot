 ...
 * </ReferenceField>
 */
exports.ReferenceFieldController = function (props) {
    ...
    return children(__assign(__assign({}, useReference_1.default(__assign(__assign({}, rest), { id: id }))), { resourceLinkPath: getResourceLinkPath_1.default(__assign(__assign({}, rest), { record: record, source: source })) }));
};
